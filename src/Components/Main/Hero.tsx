    ...
    <div className="mx-10 mt-16 mb-32 min-h-[30rem] flex flex-col">
      <div className="my-auto flex flex-col gap-y-2 whitespace-normal">
        ...
        <div className="flex w-1/2 gap-0">
          ...
          <Button className="text-4xl w-fit"><a href="https://www.linkedin.com/in/jan-russel-gorembalem-828630241/"><AiFillLinkedin/></a></Button>

          <Button className="text-4xl w-fit"><a href="https://github.com/selelel"><AiFillGithub/></a></Button>
